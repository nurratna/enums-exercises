...
class ReduceTest < Minitest::Test
  ...
  def test_multiply_list_of_numbers
    ...
    # Your code goes here
    value = 1
    result = numbers.reduce(value) do |product, number|
      product * number
    end
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    result = keywords.reduce(value) do |phrase, keyword|
  ...
  def test_divide_560_by_a_bunch_of_numbers
    ...
    # Your code goes here
    value = 560
    result = numbers.reduce(value) do |quotient, number|
      quotient / number
    end
  ...
  def test_subtract_smallest_values_from_100
    ...
    # Your code goes here
    value = 100
    result = elements.reduce(value) do |difference, element|
  ...
  def test_add_all_the_second_values_together
    ...
    # Your code goes here
    value = 0
    result = elements.reduce(value) do |sum, element|
      sum + element[1]
    end
